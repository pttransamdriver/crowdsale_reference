...
// This section is just variable declarations for the Javascript code
describe('Crowdsale', () => {
  let token, crowdsale
  let deployer, user1

  beforeEach(async () => {
    const Crowdsale = await ethers.getContractFactory('contracts/Crowdsale_exp.sol:Crowdsale_exp')
    const Token = await ethers.getContractFactory('Token_exp')
...
// This section is the actual testing of the contract
  describe('Deployment', () => {

    //This 'it' statment looks at the 
